...
export function CommunicationFilters({ onClose }: CommunicationFiltersProps) {
  return (
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <div className="space-y-2">
            {['Non lu', 'Lu', 'Urgent', 'Archivé'].map((status) => (
        ...
        <div>
          ...
          <div className="space-y-2">
            {['E-mail', 'Téléphone', 'WhatsApp', 'Message sécurisé'].map((type) => (
